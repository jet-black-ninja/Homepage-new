  ...
  return (
    ...
    >
      <main>
        <article>
          <section
            className={twMerge("min-h-screen sticky top-0 ")}
            id="aboutMe"
          >
            <AboutMe />
          </section>
          <section id="skills" className={twMerge("min-h-screen sticky top-0")}>
            <Skills />
          </section>
          <section
            id="projects"
          ...
          <section
            id="experience"
            className={twMerge("h-full sticky top-0 py-[200px] md:py-0")}
          >
            <Experience />
          </section>
          <section id="links" className={twMerge("relative md:top-0")}>
            <Links />
          </section>
        </article>
      </main>
